...
function onScreenVisibility(node) {
	// TODO
	return true
}
...
class FlexusList extends ganymedeElement() {
	...
	// start observer when list is added to DOM
	@on('connected')
	connected() {
		// FIXME: this is not being fired/called
		// TODO: start observer here
		console.log('connected')
	}

	// kill observer when list is removed from DOM
	@on('disconnected')
	disconnected() {
